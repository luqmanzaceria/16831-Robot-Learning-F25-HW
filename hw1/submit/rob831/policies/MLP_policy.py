...
class MLPPolicySL(MLPPolicy):
    ...
    def update(
        ...
        if self.discrete:
            if isinstance(action_preds, distributions.Distribution):
                loss = F.cross_entropy(action_preds.logits, actions.long())
            else:
                loss = F.cross_entropy(action_preds, actions.long())
        else:
            if isinstance(action_preds, distributions.Distribution):
