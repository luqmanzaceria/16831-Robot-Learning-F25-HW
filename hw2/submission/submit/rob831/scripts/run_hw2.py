...
class PG_Trainer(object):
    ...
    def __init__(self, params):
        ...
        train_args = {
            ...
            'num_policy_gradient_steps_per_batch': params['num_policy_gradient_steps_per_batch'],
        }
...
def main():
    ...
    parser.add_argument('--num_policy_gradient_steps_per_batch', type=int, default=1)
